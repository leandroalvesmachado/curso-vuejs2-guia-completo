<template>
	<div id="app">
		...
		<!-- <Vermelho>
            <span>Conteúdo com Componente <strong>Vermelho</strong></span>
        </Vermelho>
		<Verde>
            <span>Conteúdo com Componente <strong>Verde</strong></span>
        </Verde>
		<Azul>
            <span>Conteúdo com Componente <strong>Azul</strong></span>
        </Azul> -->

        <component :is="componente">
            <span>Conteúdo com Componente <strong>{{ componente }}</strong></span>
        </component>
	</div>
</template>
