...
export default {
    ...
    methods: {
        alterarIdade() {
            ...
            // event bus ou barramento, server para comunicação entre filhos, sem passar pelo pai
            // barramento.$emit('idadeMudou', 35);

            // de outra forma agora, usando o metodo definido no barramento.js
